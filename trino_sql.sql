...
WITH (
    location = 's3://biyi-warehouse/silver/'
);


CREATE SCHEMA gold
WITH (
    location = 's3://biyi-warehouse/gold/'
);



create table silver.test as select * from bronze.orders limit 10;
...
WITH (
    location = 's3://biyi-warehouse/silver/products/'
);
